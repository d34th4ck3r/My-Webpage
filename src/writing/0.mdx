...
<ReactTinyLink
  cardSize="large"
  showGraphic={true}
  url="https://en.wikipedia.org/wiki/Measuring_poverty"
/>


It tells percentage of people living on less than 2$ per day as of 2009. For India, it says it belongs to 61–80%.

This is an article from 2019 Hindu:
<ReactTinyLink
  cardSize="small"
  showGraphic={true}
  url="https://www.thehindubusinessline.com/news/india-slips-to-102nd-rank-in-global-hunger-report-2019/article29698494.ece"
/>
<br/>
...
According to reports from world bank, as of 2003–2007 (when these sites were build in Silicon Valley) the electricity penetration was 66.3%.

<ReactTinyLink
  cardSize="small"
  showGraphic={true}
  url="https://data.worldbank.org/indicator/EG.ELC.ACCS.ZS?locations=IN"
/>
